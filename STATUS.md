...
- The previous one-way link validator passed all 70 IPv4/IPv6 tests.
- The current bidirectional acceptance target is 140 tests and remains pending
  until the Inter-AS profile is deployed and observed again.
