...
| `xrd-eight` | Accepted compact forwarding profile for daily advanced practice | Eight XRd vRouters, four-P complete graph, three PEs and one RR/PCE/RP |
...
- [Lab 5 — XRd Eight](xrd-eight/README.md)
