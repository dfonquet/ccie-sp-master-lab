...
def render():
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" width="1800" height="1100" viewBox="0 0 1800 1100"><style>.bg{{fill:#f8fafc}}.title{{font:700 32px system-ui;fill:#0f172a}}.subtitle{{font:16px system-ui;fill:#475569}}.name{{font:700 18px system-ui;text-anchor:middle;fill:#0f172a}}.role{{font:13px system-ui;text-anchor:middle;fill:#334155}}.ip{{font:11px ui-monospace;text-anchor:middle;fill:#475569}}.tiny{{font:9px ui-monospace;text-anchor:middle;fill:#64748b}}.legend{{font:14px system-ui;fill:#334155}}</style><rect class="bg" width="100%" height="100%"/><text x="45" y="48" class="title">CCIE SP SRv6 full study profile</text><text x="45" y="77" class="subtitle">21 nodes | 14 XRd + 6 IOL-XE + AUTO1 | 33 links | validated functional underlay</text>{''.join(edges)}{''.join(boxes)}<line x1="500" y1="1050" x2="565" y2="1050" stroke="#64748b" stroke-width="2"/><text x="575" y="1055" class="legend">Provider underlay</text><line x1="760" y1="1050" x2="825" y2="1050" stroke="#7e22ce" stroke-width="3" stroke-dasharray="8 5"/><text x="835" y="1055" class="legend">PE-CE access</text><text x="45" y="1082" class="subtitle">Generated from profiles/srv6/nodes.csv and links.csv</text></svg>'''
